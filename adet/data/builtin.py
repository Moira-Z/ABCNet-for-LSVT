...
_PREDEFINED_SPLITS_TEXT = {
    ...
    "LSVT": ("LSVT/train_full_images","LSVT/annotations/train.json"),
    "syn_train": ("ch_syn/train","ch_syn/annotations/train.json"),
    "syn_test":("ch_syn/test", "ch_syn/annotations/test.json"),
}
